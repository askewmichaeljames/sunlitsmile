    ...
    var pg = {
      ...
      writeHTML: function(){
        ...
        lmnt.append(
          ...
          '<div id="pgthumbview">' +
            '<div id="pgthumbs" class="clearfix"></div>' +
          '</div>'
        );
        $('body').prepend(
        ...
        $.each(objPath,function(i,obj){
          ...
          if(i < pg.limit) {
            ...
            case 'google':
              ...
              imgTh = obj.media$group.media$thumbnail[2].url;
            ...
            $('#pgthumbs').append('<div class="item pgthumb"><a href="' + imgSrc + '"><img src="' + imgTh + '" id="pgthumbimg' + i + '" class="pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '></a></div>');
